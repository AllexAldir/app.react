...
export function Body() {
  ...
  <aside className="main-sidebar sidebar-dark-primary elevation-4">
    <a href="javascript:void(0)" className="brand-link">
      ...
      <span className="brand-text font-weight-light">TopFood</span>
    </a>
    <div className="sidebar">
      <div className="user-panel mt-3 pb-3 mb-3 d-flex">
        <div className="image">
          {/* <img src="dist/img/user2-160x160.jpg" className="img-circle elevation-2" alt="User Image" /> Pode colocar a foto do usuario aqui*/}
        </div>
        <div className="info">
